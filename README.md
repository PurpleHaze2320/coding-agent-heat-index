...
> Tracking **12** agents | **778.7k** combined stars | **+9** stars this week | Updated **2026-09-22 13:09 UTC**
...
|------|-------|:----:|------:|:-----:|:------------:|:------------:|----------|
| 1 | [Codex CLI](https://github.com/openai/codex) | 🔥🔥 **68.8** | 125.9k | — | 1394 | 3 days ago | `cli-agent` |
| 2 | [Gemini CLI](https://github.com/google-gemini/gemini-cli) | 🔥🔥 **67.6** | 107.1k | — | 42 | 6 days ago | `cli-agent` |
| 3 | [Claude Code](https://github.com/anthropics/claude-code) | 🔥🔥 **67.2** | 147.6k | — | 127 | 3 days ago | `cli-agent` |
| 4 | [Kilo Code](https://github.com/Kilo-Org/kilocode) | 🔥🔥 **66.3** | 27.4k | — | 2169 | today | `vscode-extension` |
| 5 | [Cline](https://github.com/cline/cline) | 🔥🔥 **63.8** | 69.0k | — | 281 | today | `vscode-extension` |
| 6 | [Goose](https://github.com/block/goose) | 🔥 **55.7** | 54.5k | — | 206 | 4 days ago | `cli-agent` |
| 7 | [OpenHands](https://github.com/All-Hands-AI/OpenHands) | 🔥 **55.2** | 88.8k | — | 184 | today | `autonomous-agent` |
| 8 | [Roo Code](https://github.com/RooCodeInc/Roo-Code) | 🟡 **36.4** | 24.3k | → +9 | 0 | 4 mo ago | `vscode-extension` |
...
| 11 | [Plandex](https://github.com/plandex-ai/plandex) | 🟠 **16.4** | 15.7k | — | 0 | 1y ago | `cli-agent` |
...
|--------|:-:|:-:|:-:|
| Heat Score | 68.8 | 67.6 | **Codex CLI** |
| Stars | 125.9k | 107.1k | **Codex CLI** |
| Stars (7d) | 0 | 0 | — |
| Commits (4w) | 1394 | 42 | **Codex CLI** |
| Contributors | 622 | 698 | **Gemini CLI** |
| Days since release | 3 | 6 | **Codex CLI** |
...
|------|--------|---------:|------------:|
| Big Lab | 3 | 67.9 | 380.6k |
| Indie / Open Source | 8 | 36.9 | 343.5k |
...
- **Cline** [`desktop-v0.0.33`](https://github.com/cline/cline/releases/tag/desktop-v0.0.33) — today
- **Kilo Code** [`v7.7.7`](https://github.com/Kilo-Org/kilocode/releases/tag/v7.7.7) — today
- **OpenHands** [`v1.21.0`](https://github.com/OpenHands/OpenHands/releases/tag/v1.21.0) — today
- **Claude Code** [`v2.1.278`](https://github.com/anthropics/claude-code/releases/tag/v2.1.278) — 3 days ago
- **Codex CLI** [`rust-v0.155.1`](https://github.com/openai/codex/releases/tag/rust-v0.155.1) — 3 days ago
- **Goose** [`v1.51.0`](https://github.com/aaif-goose/goose/releases/tag/v1.51.0) — 4 days ago
- **Gemini CLI** [`v0.60.0`](https://github.com/google-gemini/gemini-cli/releases/tag/v0.60.0) — 6 days ago
...
- **Most active development**: Kilo Code with **2169** commits in the last 4 weeks
- **Biggest community**: Kilo Code with **1236** contributors
- **Most installed (npm, weekly)**: Codex CLI with **14.7M** downloads
...
*Powered by GitHub Actions • Data refreshed daily • Last run: 2026-09-22 13:09 UTC*
